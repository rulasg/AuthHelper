...
function AuthHelperTest_GetPublicString{ 
...
function AuthHelperTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "AuthHelper.psd1"
...
Export-ModuleMember -Function AuthHelperTest_*
